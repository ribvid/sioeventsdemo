...
@section('content')
    <article class="wrapper flow prose">
        ...
        <p>We start with a paragraph of text that features various HTML tags, used in flow content. Account for
            <em>emphasis</em>, <strong>strong</strong> and <small>small</small> text. Don’t forget to account for
            abbreviations too, using the <abbr title="abbreviation">abbr</abbr> (<code>&lt;abbr&gt;</code>) element.
            Lastly
            you can define
        ...
        <p>If you are referencing keyboard keys, make sure you use the <code>&lt;kbd&gt;</code> element like this: <kbd>shift</kbd>.
            Like we have already in these paragraphs, if you are referencing code, use the <code>&lt;code&gt;</code>
            element.
            Don’t forget the <code>&lt;samp&gt;</code> element either. An example for that element is this: <samp>Press
                F1
                to
                continue</samp>. </p>
        <p>Use the <code>&lt;var&gt;</code> element to reference a variable like this: The volume of a box is
            <var>l</var>
            ×
            <var>w</var> × <var>h</var>, where <var>l</var> represents the length, <var>w</var> the width and
            <var>h</var>
            the
            height of the box.</p>
        <p>If you want an inline quote, use the <code>&lt;q&gt;</code> element <q>quoted text</q>. Lastly don’t forget
            the
            subscript (<code>&lt;sub&gt;</code>) (H<sub>2</sub>O) and superscript (<code>&lt;sup&gt;</code>) (E =
            MC<sup>2</sup>), and of course, <a href="https://example.com">link elements</a>. </p>
        <h2>Blockquote styles are the context for this heading level 2 which is long for testing leading and
            balance</h2>
        <blockquote>
            <p>Sed posuere consectetur est at lobortis. Nullam id dolor id nibh ultricies vehicula ut id elit. Cras
                mattis
                consectetur purus sit amet fermentum.</p>
        </blockquote>
        <blockquote cite="https://www.huxley.net/bnw/four.html">
            <q>Words can be like X-rays, if you use them properly—they’ll go through anything. You read and you’re
                pierced.</q>
        ...
        <hr>
        <p>Just a quick paragraph to follow the horizontal rule. A bit of Lipsum? Sure thing: Nulla vitae elit libero, a
            pharetra augue. Maecenas sed diam eget risus varius blandit sit amet non magna. Aenean eu leo quam.
            Pellentesque
        ...
        <ul>
            <li>List item one</li>
            <li>List item two</li>
            <li>List item three, which is a longer item to make sure our marker styles work well for mult-line list
                items
            </li>
  ...
  transition: opacity var(--transition-fade) 200ms,
    transform var(--transition-bounce-fast) 200ms;
        ...
        <p>Where are buttons? Good question. Not here because we don’t tend to style up default buttons and instead opt
            to
            treat them as components with a <code>.button</code> class.</p>
        <h2>Images, figures, pictures and videos</h2>
        <p>Under no circumstances should you have an image without an <code>alt</code> attribute. At a minimum, it
            should
            be
            an empty value like this one. That should only be used for purely decorative images though. </p>
        <img
                src="https://images.unsplash.com/photo-1579546929518-9e396f3cc809?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwxfDB8MXxyYW5kb218MHx8fHx8fHx8MTY4MjA3NzQ4Mg&ixlib=rb-4.0.3&q=80&w=1080"
                alt="">
        <h3>An image in a figure with a caption</h3>
        <figure>
            <img
                    src="https://images.unsplash.com/photo-1696251143046-2d32fb985b59?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=4470&q=80"
                    alt="A Tokyo street in the early evening dusk. The shot is from under a steel bridge where there is a store, lit up, which in turn, lights up the surrounding area.">
            <figcaption>Tokyo, Japan, looking stunning in the early evening. By <a
                        href="https://unsplash.com/@ayumikubo">ayumi
                    kubo</a>
            </figcaption>
        </figure>
        ...
        <picture>
            <source
                    srcset="https://images.unsplash.com/photo-1692946573219-2257a4a29cad?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1500&h=1500&q=80"
                    media="(min-width: 1500px)">
            <source
                    srcset="https://images.unsplash.com/photo-1692946573219-2257a4a29cad?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80"
                    media="(orientation: portrait)">
            <img
                    src="https://images.unsplash.com/photo-1692946573219-2257a4a29cad?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=500&h=500&q=80"
                    alt="An above shot of some very green leaves">
        </picture>
        ...
        <svg role="img" aria-label="a black spiral" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 331.27 316.68"
            ...
            <path fill="#000"
                  ...
                  transform="translate(-28.63 -22.72)"/>
        </svg>
        <h2>All of the headings</h2>
        <p>We tend to only specifically style up headings up to level 4 in terms of leading and balance because if
            you’re
            getting into 5 and 6, you probably want to be simplifying your content. We’ll add them here though to double
            check
            they look OK.</p>
